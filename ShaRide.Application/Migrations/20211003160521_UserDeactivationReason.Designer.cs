...
namespace ShaRide.Application.Migrations
{
    ...
    [Migration("20211003160521_UserDeactivationReason")]
    partial class UserDeactivationReason
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShaRide.Domain.Entities.Attachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<int?>("RideFeedbackId")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("RideFeedbackId");
            ...
            modelBuilder.Entity("ShaRide.Domain.Entities.RideFeedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ShaRide.Domain.Entities.UserDeactivationHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("UserDeactivationHistory");
                });
            ...
            modelBuilder.Entity("ShaRide.Domain.Entities.Attachment", b =>
                {
                    b.HasOne("ShaRide.Domain.Entities.RideFeedback", null)
                        .WithMany("Files")
                        .HasForeignKey("RideFeedbackId");
                });
            ...
            modelBuilder.Entity("ShaRide.Domain.Entities.UserDeactivationHistory", b =>
                {
                    b.HasOne("ShaRide.Domain.Entities.User", null)
                        .WithMany("DeactivationHistory")
                        .HasForeignKey("UserId");
                });
